  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route
          path="/Quotations"
          element={<UserRoute element={<Quotations />} />}
        />
        <Route
          path="/Quotations/:quotationId"
          element={<UserRoute element={<QuotationDetail />} />}
        />
        ...
        />
        <Route
          path="/Admin/RatingManage"
          element={<AdminRoute element={<RatingManage />} />}
        />
        <Route path="/nhan-vien-tu-van" element={<ConsultingStaff />} />
        <Route path="/nhanvien" element={<DesignStaffPage />} />
      </Routes>
    </div>
  );
